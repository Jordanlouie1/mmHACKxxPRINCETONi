...
class DishPage extends StatelessWidget {
  ...
  List<Text> convertStringsToWidgets(List<dynamic> interests) {
    List<Text> interestsList = <Text>[];
    for (dynamic interest in interests) {
      interests.add(Text((interest.toString())));
    }
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Align(
                            alignment: Alignment.centerLeft,
                            child: Text(
                              'Interests: ' + dishWidget!.interests!,
                              style: const TextStyle(
